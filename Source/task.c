...
void vU8G2TimerCallback(TimerHandle_t pxTimer) {
    ...
    while (x < U8G2.Width - 1) {
        u8g2_DrawLine(
            &U8G2.u8g2, (float)x * (U8G2.Width - 1) / (Sampler.Length - 1),
            U8G2.Height - 1 -
                ((float)Sampler.Data[Index] * (U8G2.Height - 1) / 2. / 4095. +
                 U8G2.Height / 4.),
            (float)(x + 1) * (U8G2.Width - 1) / (Sampler.Length - 1),
            U8G2.Height - 1 -
                ((float)Sampler.Data[(Index + 1) % Sampler.Length] *
                     (U8G2.Height - 1) / 2. / 4095. +
                 (U8G2.Height - 1) / 4.));
